...
import com.example.danijelsojat.stepcounter.databinding.FragmentThirtyDayInfoBinding
...
class ThirtyDayInfoFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        binding = FragmentThirtyDayInfoBinding.inflate(inflater, container, false)
        return binding.root
    }
    ...
    private fun getBarChartDataForSet1(): ArrayList<BarEntry> {
        ...
        barEntriesList.add(BarEntry(1f, thirtyDaySteps.toFloat()))
    ...
    private fun getBarChartDataForSet2(): ArrayList<BarEntry> {
        ...
        barEntriesList.add(BarEntry(1f, dailyGoal*30))
        return barEntriesList
    }
}