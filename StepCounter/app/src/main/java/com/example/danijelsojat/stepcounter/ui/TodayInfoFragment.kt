...
class TodayInfoFragment : Fragment() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        dailyGoal = requireContext()
            .getSharedPreferences(DAILY_GOAL_PREFS, MODE_PRIVATE)
    ...
    private fun getBarChartDataForSet1(): ArrayList<BarEntry> {
        ...
        barEntriesList.add(BarEntry(1f, todaySteps.toFloat()))
    ...
    private fun getBarChartDataForSet2(): ArrayList<BarEntry> {
        ...
        barEntriesList.add(BarEntry(1f, dailyGoal))
        return barEntriesList
    }
}